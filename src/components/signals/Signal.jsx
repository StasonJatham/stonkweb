        ...
        <>
            <div className="relative flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
                <div className="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white rounded-none bg-clip-border">
                        ...
                        <div className="block w-full overflow-hidden md:w-max">
                            <nav>
                                <ul role="tablist" className="relative flex flex-row p-1 rounded-lg bg-blue-gray-50 bg-opacity-60">
                                    ...
                                    >
                                        <button value="all" className="z-20 text-inherit">
                                            &nbsp;&nbsp;All&nbsp;&nbsp;
                                        </button>
                                    ...
                                    <li role="tab"
                                        className="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center bg-transparent cursor-pointer select-none text-blue-gray-900"
                                    >
                                        <button value="active" className="z-20 text-inherit">
                                            &nbsp;&nbsp;Active&nbsp;&nbsp;
                                        </button>
                                    ...
                                    <li role="tab"
                                        ...
                                        className="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center bg-transparent cursor-pointer select-none text-blue-gray-900"
                                    >
                                        <button value="inactive" className="z-20 text-inherit">
                                            &nbsp;&nbsp;Inactive&nbsp;&nbsp;
                                        </button>
                    ...
                    <div className='mt-4'>
                        <p>Results {quickSignals.length}</p>
                    </div>
                </div>
                    ...
                    <table className="w-full mt-4 text-left table-auto min-w-max">
                        ...
                        <tbody>
                            {quickSignals.map((signal) => (
                                <tr key={signal.id + "_" + signal.option}>
                                    <td className="p-4 border-b border-blue-gray-50">
                                        <div className="flex items-center gap-3">

                                            <div className="flex flex-col">
                                                <p className="uppercase block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                                    {signal.option.split("--")[0]}
                                                </p>
                                                <p className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                                    {signal.option.split('-')[signal.option.split('-').length - 1]}
                                                </p>
                                                <p
                                                    className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900 opacity-70">
                                                    {prettyTimestamp(signal.created_at)}
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="p-4 border-b border-blue-gray-50">
                                        <div className="flex flex-col">
                                            ...
                                            <p className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                                ...
                                                {signal.dividend && "dividend"}
                                                {signal.delta && "delta"}
                                                {signal.strike_distance && "strike_distance"}
                                                {signal.strike_hit && "strike_hit"}
                                                {signal.iv && "iv"}
                                                {signal.expiration && "expiration"}
                                                {signal.economic_events && "economic_events"}
                                        ...
                                        <div className="w-max">
                                            {signal.score <= 5 &&
                                                <div
                                                    ...
                                                    <span className="">{signal.score} / {signal.score_max}</span>
                                                </div>}
                                            {signal.score > 5 && signal.score < 9 &&
                                                <div
                                                    className="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-yellow-900 uppercase rounded-md select-none whitespace-nowrap bg-orange-500/20">
                                                    <span className="">{signal.score} / {signal.score_max}</span>
                                                </div>}
                                            {signal.score >= 9 &&
                                                <div
                                                    ...
                                                    <span className="">{signal.score}</span>
                                                </div>}
                                        </div>
                                    </td>
                                    <td className="p-4 border-b border-blue-gray-50">
